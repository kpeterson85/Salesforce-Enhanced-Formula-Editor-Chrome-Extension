editAreaLoader.load_syntax["forceformula"] = {
	...
	,'KEYWORDS' : {
		...
		,'functions' : [
			'ABS','BEGINS','BLANKVALUE','BR','CASESAFEID','CEILING','CONTAINS','DATE','DATEVALUE','DAY','DISTANCE','EXP','FIND','FLOOR','GEOLOCATION','GETSESSIONID','HYPERLINK','IMAGE','INCLUDES','ISBLANK','ISCHANGED','ISNEW','ISNULL','ISNUMBER','ISPICKVAL','LEFT','LEN','LN','LOG','LOWER','LPAD','MAX','MID','MIN','MOD','MONTH','NOT','NOW','NULLVALUE','PRIORVALUE','REGEX','RIGHT','ROUND','RPAD','SQRT','SUBSTITUTE','TEXT','TODAY','TRIM','UPPER','VALUE','VLOOKUP','YEAR'
		]
		,'reserved' : [
			'true','false'
		]
