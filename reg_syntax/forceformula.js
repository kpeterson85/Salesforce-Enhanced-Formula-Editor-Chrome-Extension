editAreaLoader.load_syntax["forceformula"] = {
	...
	,'KEYWORDS' : {
		...
		,'functions' : [
			'ABS', 'ACOS', 'ADDMONTHS', 'ASCII', 'ASIN', 'ATAN', 'ATAN2', 'BEGINS', 'BLANKVALUE', 'BR', 'CASESAFEID', 'CEILING', 'CHR', 'CONTAINS', 'COS', 'CURRENCYRATE', 'DATE', 'DATETIMEVALUE', 'DATEVALUE', 'DAY', 'DAYOFYEAR', 'DISTANCE', 'EXP', 'FIND', 'FLOOR', 'FORMATDURATON', 'FROMUNIXTIME', 'GEOLOCATION', 'GETSESSIONID', 'HOUR', 'HYPERLINK', 'IMAGE', 'INCLUDES', 'INITCAP', 'ISBLANK', 'ISCHANGED', 'ISCLONE', 'ISNEW', 'ISNULL', 'ISNUMBER', 'ISOWEEK', 'ISOYEAR', 'ISPICKVAL', 'LEFT', 'LEN', 'LN', 'LOG', 'LOWER', 'LPAD', 'MAX', 'MCEILING', 'MFLOOR', 'MID', 'MILLISECOND', 'MIN', 'MINUTE', 'MOD', 'MONTH', 'NOT', 'NOW', 'NULLVALUE', 'PI', 'PICKLISTCOUNT', 'PRIORVALUE', 'REGEX', 'RIGHT', 'ROUND', 'RPAD', 'SECOND', 'SIN', 'SQRT', 'SUBSTITUTE', 'TAN', 'TEXT', 'TIMENOW', 'TIMEVALUE', 'TODAY', 'TRIM', 'TRUNC', 'UNIXTIMESTAMP', 'UPPER', 'VALUE', 'VLOOKUP', 'WEEKDAY', 'YEAR'
		]
		,'reserved' : [
			'true','false'
		]
